...
export function Step4ScheduleSend({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Broadcast Name */}
      <div>
        <label className="mb-1.5 block text-sm font-medium text-white">Nome do Disparo</label>
        <Input
          value={name}
        ...
        <div className="rounded-xl border border-primary/20 bg-primary/5 p-4">
          <div className="mb-2 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm font-medium text-white">Enviando disparo...</p>
            </div>
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 border-t border-slate-800 pt-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <DialogContent className="border-slate-700 bg-slate-900 sm:max-w-md">
            <DialogHeader>
              <DialogTitle className="text-white">Confirmar Disparo</DialogTitle>
